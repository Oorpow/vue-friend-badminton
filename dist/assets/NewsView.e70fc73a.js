import { u as useRouter, o as opRequest, d as defineStore, e as __vitePreload, s as storeToRefs } from "./index.a1ce5fd2.js";
import { u as useInvitationStore, H as Header, f as filter_default } from "./Header.9e0cb1ea.js";
import { u as useCommentStore } from "./comment.3f3d08ae.js";
import { u as usePlayerStore } from "./player.96c272f6.js";
const _hoisted_1$1 = { class: "p-3 border-1 border-gray-2 dark:border-gray-800 rounded-lg mt-5 first:mt-0" };
...
const _hoisted_1 = { class: "min-h-60 relative" };
const _hoisted_2 = { class: "sm:w-full lg:w-7/10 mx-auto my-10 flex justify-around relative" };
const _hoisted_3 = { class: "w-9/10 lg:w-2/3 flex flex-col overflow-hidden" };
const _hoisted_4 = { class: "hidden lg:block w-1/4" };
const _hoisted_5 = {
  sticky: "",
  "top-5": ""
};
...
const _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    const NewsList = Vue.defineAsyncComponent(
      () => __vitePreload(() => import("./NewsList.4568b200.js"), true ? ["./NewsList.4568b200.js","./NewsItem.6ac0d974.js","./index.a1ce5fd2.js","./index.f3dff048.css","./Header.9e0cb1ea.js","./Header.039dfc54.css","./NewsItem.38283a99.css","./NewsList.793c909b.css"] : void 0, import.meta.url)
    );
