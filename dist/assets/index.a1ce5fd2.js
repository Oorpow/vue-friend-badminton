...
function mergeReactiveObjects(target, patchToApply) {
  ...
  for (const key in patchToApply) {
    ...
    if (isPlainObject$1(targetValue) && isPlainObject$1(subPatch) && target.hasOwnProperty(key) && !VueDemi.isRef(subPatch) && !VueDemi.isReactive(subPatch)) {
...
function shouldHydrate(obj) {
  return VueDemi.isVue2 ? !skipHydrateMap.has(obj) : !isPlainObject$1(obj) || !obj.hasOwnProperty(skipHydrateSymbol);
}
...
function createOptionsStore(id, options, pinia2, hot) {
  ...
  function setup() {
    if (!initialState && true) {
      if (VueDemi.isVue2) {
        VueDemi.set(pinia2.state.value, id, state ? state() : {});
      } else {
        pinia2.state.value[id] = state ? state() : {};
      }
    }
    const localState = VueDemi.toRefs(pinia2.state.value[id]);
...
function createSetupStore($id, setup, options = {}, pinia2, hot, isOptionsStore) {
  ...
  if (!isOptionsStore && !initialState && true) {
    if (VueDemi.isVue2) {
      VueDemi.set(pinia2.state.value, $id, {});
    } else {
  ...
  const partialStore = {
    ...
    $subscribe(callback, options2 = {}) {
      ...
      const stopWatcher = scope.run(() => VueDemi.watch(() => pinia2.state.value[$id], (state) => {
  ...
  for (const key in setupStore) {
    ...
    if (VueDemi.isRef(prop) && !isComputed(prop) || VueDemi.isReactive(prop)) {
      if (!isOptionsStore) {
        ...
        if (VueDemi.isVue2) {
          VueDemi.set(pinia2.state.value[$id], key, prop);
        } else {
  ...
  if (VueDemi.isVue2) {
    ...
    assign$1(VueDemi.toRaw(store), setupStore);
  }
...
function defineStore(idOrOptions, setup, setupOptions) {
  ...
  function useStore(pinia2, hot) {
    ...
    pinia2 = pinia2 || currentInstance && VueDemi.inject(piniaSymbol);
    if (pinia2)
      setActivePinia(pinia2);
    pinia2 = activePinia;
    if (!pinia2._s.has(id)) {
...
function storeToRefs(store) {
  if (VueDemi.isVue2) {
    ...
    for (const key in store) {
      ...
      if (VueDemi.isRef(value2) || VueDemi.isReactive(value2)) {
...
function merge$1(destination, source) {
  ...
  keys.forEach((key) => {
    if (Array.isArray(destination[key]) && Array.isArray(source[key])) {
      result[key] = [
        ...Object.values(
          merge$1(destination[key], source[key])
        )
      ];
      ...
      for (const item of referencedArray) {
        if (pathArrayAfterArray.length !== 0 && (Array.isArray(item) || typeof item === "object")) {
          referencedArraySubstate.push(
            pick$1(item, [pathArrayAfterArray.join(".")])
          );
        } else {
...
const normalize = "";
const global$1 = "";
const _imports_0 = "data:image/png;base64,";
const _imports_1 = "data:image/png;base64,";
/*!
  * vue-router v4.1.6
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
...
function isEquivalentArray(a, b) {
  return isArray$1(b) ? a.length === b.length && a.every((value2, i2) => value2 === b[i2]) : a.length === 1 && a[0] === b;
}
...
const _withScopeId = (n) => (Vue.pushScopeId("data-v-a98fdf0a"), n = n(), Vue.popScopeId(), n);
const _hoisted_1$1 = {
  flex: "",
  "items-center": "",
  "w-full": "",
...
const _hoisted_2 = { class: "w-8/10 m-auto flex items-center justify-center" };
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ Vue.createElementVNode("div", { "w-10": "" }, [
...
const _hoisted_7 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ Vue.createElementVNode("div", {
  flex: "",
  "w-10": "",
  "justify-center": "",
  "items-center": ""
}, [
  /* @__PURE__ */ Vue.createElementVNode("div", { class: "w-2" }, [
    /* @__PURE__ */ Vue.createElementVNode("a", { href: "https://github.com/Oorpow/vue-friend-badminton" }, [
      /* @__PURE__ */ Vue.createElementVNode("img", {
        src: _imports_1,
        alt: "github",
        "w-full": "",
        ...
        Vue.createElementVNode("div", _hoisted_2, [
          ...
          Vue.createElementVNode("div", _hoisted_4, [
            Vue.createElementVNode("ul", _hoisted_5, [
              (Vue.openBlock(), Vue.createElementBlock(Vue.Fragment, null, Vue.renderList(navList, (item) => {
...
const Footer_vue_vue_type_style_index_0_scoped_a98fdf0a_lang = "";
...
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a98fdf0a"]]);
const _hoisted_1 = { "min-h-90vh": "" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return Vue.openBlock(), Vue.createElementBlock(Vue.Fragment, null, [
        ...
        Vue.unref(showFooter) ? (Vue.openBlock(), Vue.createBlock(Footer, { key: 0 })) : Vue.createCommentVNode("", true)
      ], 64);
    };
  }
});
...
const routes = [
  {
    path: "/login",
    name: "login",
    component: () => __vitePreload(() => import("./LoginView.cc971418.js"), true ? ["./LoginView.cc971418.js","./LoginView.2b6253ae.css"] : void 0, import.meta.url)
  },
  {
    path: "/",
    name: "home",
    component: () => __vitePreload(() => import("./HomeView.d0066f2f.js"), true ? ["./HomeView.d0066f2f.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./player.96c272f6.js","./HomeView.cb08d1b7.css"] : void 0, import.meta.url)
  },
  {
    path: "/player/:id",
    name: "player",
    component: () => __vitePreload(() => import("./PlayerView.a8449af5.js"), true ? ["./PlayerView.a8449af5.js","./Header.9e0cb1ea.js","./Header.039dfc54.css"] : void 0, import.meta.url),
    children: [
      {
        path: "career",
        name: "career",
        component: () => __vitePreload(() => import("./PlayerCareerView.49e3dece.js"), true ? ["./PlayerCareerView.49e3dece.js","./player.96c272f6.js","./PlayerCareerView.ad409635.css"] : void 0, import.meta.url)
      }
    ]
  },
  {
    path: "/news/:type",
    name: "news",
    component: () => __vitePreload(() => import("./NewsView.e70fc73a.js"), true ? ["./NewsView.e70fc73a.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./comment.3f3d08ae.js","./player.96c272f6.js"] : void 0, import.meta.url)
  },
  {
    path: "/news_det/:id",
    name: "detail",
    component: () => __vitePreload(() => import("./DetailView.f525b2f3.js"), true ? ["./DetailView.f525b2f3.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./index.02b5b7d6.js","./comment.3f3d08ae.js","./DetailView.21928a21.css"] : void 0, import.meta.url)
  },
  {
    path: "/match",
    name: "match",
    component: () => __vitePreload(() => import("./MatchView.b47c115a.js"), true ? ["./MatchView.b47c115a.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./index.02b5b7d6.js","./MatchView.ac42ff99.css"] : void 0, import.meta.url)
  },
  {
    path: "/message",
    name: "message",
    component: () => __vitePreload(() => import("./MessageView.2c034fb6.js"), true ? ["./MessageView.2c034fb6.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./MessageView.1af7145f.css"] : void 0, import.meta.url)
  },
  {
    path: "/produce",
    name: "produce",
    component: () => __vitePreload(() => import("./ProduceView.f6330bf7.js"), true ? ["./ProduceView.f6330bf7.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./index.1609e130.js","./ProduceView.23cad928.css"] : void 0, import.meta.url)
  },
  {
    path: "/space/:id",
    name: "space",
    component: () => __vitePreload(() => import("./SpaceView.a76f2d08.js"), true ? ["./SpaceView.a76f2d08.js","./Header.9e0cb1ea.js","./Header.039dfc54.css","./comment.3f3d08ae.js","./index.1609e130.js","./SpaceView.f345d93d.css"] : void 0, import.meta.url)
  }
];
const ignoreList = [
  "/message",
...
function dispatchRequest(config2) {
  ...
  const adapter = config2.adapter || defaults.adapter;
...
class Axios {
  ...
  request(configOrUrl, config2) {
    ...
    const defaultHeaders = config2.headers && utils.merge(
    ...
    config2.headers = new AxiosHeaders(config2.headers, defaultHeaders);
...
class OpRequest {
  constructor(config2) {
    ...
    this.showLoading = (_a = config2.showLoading) != null ? _a : true;
    this.instance.interceptors.request.use(
      (_b = config2.interceptors) == null ? void 0 : _b.requestInterceptors
    );
    this.instance.interceptors.response.use(
      (_c = config2.interceptors) == null ? void 0 : _c.responseInterceptors
    );
    this.instance.interceptors.request.use(
      (config22) => {
        return config22;
    ...
    this.instance.interceptors.response.use(
      ...
      (err) => {
        var _a2, _b2;
        this.handleStatus((_a2 = err.response) == null ? void 0 : _a2.status);
        ElementPlus.ElMessage({
          type: "warning",
          message: (_b2 = err.response) == null ? void 0 : _b2.data
        });
        return err;
      }
    );
  ...
  request(config2) {
    return new Promise((resolve, reject) => {
      var _a;
      if (config2.showLoading === false) {
        this.showLoading = config2.showLoading;
      }
  ...
  get(config2) {
    return this.instance.request({ ...config2, method: "GET" });
  }
  post(config2) {
    return this.instance.request({ ...config2, method: "POST" });
  }
  put(config2) {
    return this.instance.request({ ...config2, method: "PUT" });
  }
  patch(config2) {
    return this.instance.request({ ...config2, method: "PATCH" });
  }
  handleStatus(status) {
    switch (status) {
      case 401:
...
const userLogin = (loginForm) => opRequest.post({
  url: "/login",
  data: loginForm
});
const userLogout = (id) => opRequest.post({
  url: "/login/out",
  data: {
    id
  }
});
const userRegister = (registerForm) => opRequest.post({
  url: "/user",
  data: registerForm
});
const userSearchByName = (username) => opRequest.post({
  url: "/user/search",
  data: {
    username
  }
});
const userInfoGetById = (id) => opRequest.get({
  url: `/user/${id}`
});
const updateInfo = (form) => opRequest.patch({
  url: "/user",
  data: form
});
const updateUserBg = (userId, url2) => opRequest.patch({
  url: "/user/bg",
  data: {
    userId,
    url: url2
...
const updateUserAvatar = (userId, url2) => opRequest.patch({
  url: "/user/avatar",
  data: {
    userId,
    url: url2
...
const useUserStore = defineStore("userStore", {
  ...
  actions: {
    ...
    async updateUserSpaceBg(id, url2) {
      await updateUserBg(id, url2);
    },
    async updateUserAvatar(id, url2) {
      await updateUserAvatar(id, url2);
    },
...
const socket = lookup("http://175.178.99.5:8001", {
  autoConnect: false
});
