import { u as useInvitationStore, o as camera_default, e as useFriendStore, H as Header, _ as _sfc_main$5, q as setting_default } from "./Header.32a9e012.js";
import { e as __vitePreload, c as useRoute, a as useUserStore, s as storeToRefs, u as useRouter, b as _export_sfc } from "./index.ef5f85cc.js";
import { u as useCommentStore } from "./comment.48a3b0e4.js";
import { i as imageConversion } from "./index.e0364ada.js";
const _hoisted_1$3 = { style: { "padding": "14px" } };
const _hoisted_2$3 = { style: { "display": "flex", "align-items": "center", "justify-items": "space-between" } };
...
const _sfc_main$3 = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    const NewsItem = Vue.defineAsyncComponent(
      () => __vitePreload(() => import("./NewsItem.84be6d78.js"), true ? ["./NewsItem.84be6d78.js","./index.ef5f85cc.js","./index.823298b7.css","./Header.32a9e012.js","./Header.bcf594a4.css","./NewsItem.1edce874.css"] : void 0, import.meta.url)
    );
...
const _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const tabList = Vue.reactive([
      { id: 1, name: "\u6295\u7A3F", comName: Vue.markRaw(_sfc_main$3) }
    ]);
    const defaultStyle = {
      marginTop: "-15px",
      border: "4px solid #fff"
    };
    const currentTab = Vue.shallowRef(_sfc_main$3);
    ...
    Vue.watch(
      ...
      (newVal) => {
        ...
        if (userInfo.value.id) {
          tabList.push({ id: 2, name: "\u5173\u6CE8\u5217\u8868", comName: Vue.markRaw(_sfc_main$2) });
...
const SpaceView_vue_vue_type_style_index_0_scoped_dc105aa5_lang = "";
const SpaceView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dc105aa5"]]);
export {
